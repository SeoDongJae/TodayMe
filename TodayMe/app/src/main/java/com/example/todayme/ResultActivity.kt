...
import com.example.todayme.database.DiaryDatabase
import com.example.todayme.database.DiaryInfo
import com.example.todayme.databinding.ActivityResultBinding
    ...
    override fun onClick(view: View?) {
        when (view!!.id) {
            R.id.btn_complete-> {
                ...
                // 일기 데이터 생성
                val diaryInfo = DiaryInfo(binding.etContent.text.toString(), SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Date()))
